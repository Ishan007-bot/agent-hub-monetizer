  ...
  const faqs = [
    {
      ...
      answer: 'Lovable AI is a marketplace platform where developers can upload their AI code, automatically convert it into deployable agents using Gradio, and monetize their work through a token-based economy. Users can discover and use these AI agents for various tasks.'
    },
    {
      category: 'getting-started',
